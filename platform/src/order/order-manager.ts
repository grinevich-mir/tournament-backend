...
import { OrderCreatedEvent, OrderPaymentFailedEvent, OrderStatusChangedEvent } from './events';
...
export class OrderManager {
    constructor(
        @Inject private readonly repository: OrderRepository,
    ...
    public async add(order: NewOrder): Promise<Order> {
        ...
        await this.eventDispatcher.send(new OrderCreatedEvent(added.id));
        return added;
    }
